...
export interface ApiTemplateTemplate extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required;
    language: Attribute.Enumeration<['en-us', 'zh-tw']> & Attribute.Required;
    ...
    scenario: Attribute.Enumeration<
      [
    ...
    supported: Attribute.Component<'template.supported'> & Attribute.Required;
    tags: Attribute.Component<'shared.tag', true>;
    template_link: Attribute.String & Attribute.Required;
    template_status: Attribute.Enumeration<
